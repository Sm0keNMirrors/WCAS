...
# =====================================================================
  ...
  if ($NEW_START == true || $NEW_START == TRUE ) then
     setenv ICFILE ICON_v532_${APPL}_profile_${APPL}  
   #   setenv ICFILE ICON_v54_${APPL}_profile_20220727 # icon初始时间写错了才用
  ...
  #> Boundary conditions
  set BCFILE = BCON_v532_${YYYYJJJ}_profile_${YYYYMMDD}
