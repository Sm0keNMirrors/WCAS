...
setenv d01_GRID_NAME CDsvSA15_d01
...
set APPL = 20241214
	...
	#   setenv RUNLEN          240000
	 ...
	 if ( $BCON_TYPE == regrid ) then 
	    # setenv CTM_CONC_1 /home/shiroko/CMAQdata/$d01_GRID_NAME/cctm/CCTM_CONC_v54_ISAM_gcc_${APPL}_${YYYYMMDD}.nc
		setenv CTM_CONC_1 ${CMAQdata_dir}${d01_GRID_NAME}/cctm/CCTM_CONC_v532_gcc_${APPL}_${YYYYMMDD}.nc
	    setenv MET_CRO_3D_CRS ${CMAQdata_dir}$d01_GRID_NAME/mcip/METCRO3D_${YYYYJJJ}.nc
