...
#-----------------------------------------------------------------------
set CMAQ_HOME = /home/shiroko/CMAQ/CMAQv5.3/

rm -rf $CMAQ_HOME/PREP/mcip/scripts/mcipcsh.ok

source $CMAQ_HOME/config_cmaq.csh

set start_time = 2019-12-31
set end_time = 2020-02-01
set domain = 3

set CoordName  = LamCon_35N_105W    # 16-character maximum
set GridName = CQ202001_MEIAT-IA_d03

set DataPath = /home/shiroko/WCAS/simulations/CQ202001_MEIAT-IA/
set InMetDir = /home/shiroko/WRF-4.1.2/run/WRFoutput
set InGeoDir = /home/shiroko/WCAS/simulations/CQ202001_MEIAT-IA/WPSoutput
set OutDir     = $DataPath/$GridName/mcip #mcip结果输出路径
...
while ($end_time_s > $start_time_s)
	...
	set InMetFiles = ( $InMetDir/wrfout_d0${domain}_${previous_time}_00:00:00 \
	                   $InMetDir/wrfout_d0${domain}_${start_time}_00:00:00 \
	                   $InMetDir/wrfout_d0${domain}_${next_time}_00:00:00 )
	echo $InMetFiles 
	set IfGeo      = "T"
	set InGeoFile  = $InGeoDir/geo_em.d0${domain}.nc
	...
	set MCIP_START = ${start_time}-00:00:00.0000  # [UTC]
	set MCIP_END   = ${next_time}-00:00:00.0000  # [UTC]
...
if ( $status == 0 ) then
  rm fort.*
  touch $CMAQ_HOME/PREP/mcip/scripts/mcipcsh.ok
  exit 0
else
